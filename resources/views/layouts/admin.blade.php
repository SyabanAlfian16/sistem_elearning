...
<head>
	...
	<title>E-Learning SMAN 1 Pasawahan</title>
		...
		<header class="header">
			<div class="logo-container">
				<a href="/admin/index" class="logo">
					<img src="{{asset('admin/img/sma.png')}}" width="40" height="35" alt="Porto Admin" />
				</a>
				<p class="logo pt-1	">
					<b>E-Learning SMAN 1 Pasawahan</b>
				</p>
				...
				<ul class="nav nav-main">
					...
					<li class="nav-parent">
						...
						<ul class="nav nav-children">
							...
							<li>
								<a class="nav-link" href="{{Route('siswaLaporan')}}">
									Cetak laporan siswa
								</a>
							</li>
							<li>
								<a class="nav-link" href="{{Route('mapelLaporanmapel')}}">
									Cetak laporan mapel
								</a>
							</li>
							<li>
								<a class="nav-link" href="{{Route('pertemuanIndex')}}">
									Cetak laporan Pertemuan
								</a>
							</li>
							<li>
							...
							<li>
								<a class="nav-link" href="{{Route('tes-adminIndex')}}">
									Laporan data kuis
								</a>
							</li>
						</ul>
			...
			<div class="sidebar-widget widget-tasks">
				...
				<div class="widget-content">
					<ul class="list-unstyled m-0">
						...
						<li><a href="{{Route('instrukturIndex')}}">Data Guru</a></li>
					</ul>
				</div>
			</div>
		</div>
