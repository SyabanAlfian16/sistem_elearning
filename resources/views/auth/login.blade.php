	...
	<header class="header bg-dark mt-0 pt-0">
		<div class="logo-container">
			<a href="../2.2.0" class="logo">
				<img src="{{asset('admin/img/sma.png')}}" width="35" height="35" alt="Porto Admin" />
			</a>
			<p class="logo pt-1 text-white">
				<b><a href="#" id="modal-trigger" data-toggle="modal" data-target="#exampleModal">E-Learning SMAN 1 Pasawahan</a></b>
			</p>
...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">E-Learning SMAN 1 Pasawahan</h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				<span aria-hidden="true">&times;</span>
			</button>
		</div>
		<div class="modal-body">
			<strong>SMA Negeri 1 Pasawahan merupakan sekolah menengah atas yang sudah sangat terkenal 
				...
				mengurangi anak putus sekolah dasar dan memutus rantai kemiskinan dari akarnya.</strong>
		</div>
