...
<body>
   ...
   <hr>
    ...
    <div class="container">
        <div class="isi">
            <h4 style="text-align:center; text-transform:uppercase;">LAPORAN DATA ABSENSI <br> PERTEMUAN {{$data->pertemuan}} - {{carbon\carbon::parse($data->tanggal)->translatedFormat('d F Y')}} </h4>
            <br>            
