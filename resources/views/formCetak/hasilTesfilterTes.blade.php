...
<body>
   ...
   <hr>
    ...
    <div class="container">
        <div class="isi">
            <h4 style="text-align:center; text-transform:uppercase;">LAPORAN DATA HASIL TES MAPEL {{$data->first()->tes->mapel->mapel}} Periode {{carbon\carbon::parse($data->first()->tes->periode->tahun)->translatedFormat('Y')}}</h4>
            <br>            
