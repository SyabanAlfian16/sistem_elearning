...
<section role="main" class="content-body">
    <header class="page-header">
        <h2>{{$data->pertemuan}} {{$data->mapel->mapel}} {{$data->mapel->deskripsi}}</h2>
        ...
        <div class="col-lg-12 ">
            <div class="text-right mb-3">
                ...
                <form action="{{Route('absensiStore')}}" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fas fa-hand-paper"></i> Klik Untuk Absensi</button>
                </form>
                @else
