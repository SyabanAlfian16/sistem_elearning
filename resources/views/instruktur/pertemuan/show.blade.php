        ...
        <div class="col-lg-12">
                        ...
                        <table class="table table-bordered table-striped mb-0" id="datatable-default">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{Route('instrukturModulEdit',['uuid' => $d->uuid])}}"
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="text-right">
                        <button class="btn btn-sm btn-success" id="tambahTes"><i class="fa fa-plus"></i> Tambah Data</button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped mb-0" id="datatable-default">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{Route('instrukturTugasEdit',['uuid' => $d->uuid])}}"
                                            class="btn btn-sm btn-primary m-1 "> <i class="fa fa-edit"></i></a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{Route('instrukturModulStore')}}" method="post" enctype="multipart/form-data">
                    @csrf
...
<div class="modal fade bd-example-modal-lg" id="modalTes" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{Route('instrukturTugasStore')}}" method="post">
                    @csrf
                    <input type="hidden" name="uuid" value="{{$data->uuid}}">
                    <div class="form-group ">
...
<script>
    $("#tambahModul").click(function(){
        ...
        function HapusModul(uuid,nama) {
			...
			if (result.value) {
				url = "{{Route('instrukturModulDestroy','')}}";
        ...
        function HapusTugas(uuid,nama) {
			...
			if (result.value) {
				url = "{{Route('instrukturTugasDestroy','')}}";
				window.location.href =  url+'/'+uuid ;			
			}
		})
        }
