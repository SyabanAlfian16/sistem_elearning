            ...
            <div class="modal-body">
                <form action="{{Route('instrukturPertemuanStore')}}" method="post">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" name="nama_guru" id="nama_guru" value="{{$data->instruktur->user->nama}}" required>
                    </div>
                    <input type="hidden" name="uuid" value="{{$data->uuid}}" id="">
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="#" class="form-control" name="kelas" id="kelas" value="{{$data->deskripsi}}" required>
                    </div>
                    <div class="form-group ">
