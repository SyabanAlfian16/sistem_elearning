...
//siswa
    ...
    Route::get('/siswa/laporan', 'laporanController@index')->name('siswaLaporan');
...
//mapel
    ...
    Route::get('/mapel/laporanmapel', 'laporanmapelController@index')->name('mapelLaporanmapel');
...
//Tes
    Route::get('/tes-admin/index', 'tesadminController@index')->name('tes-adminIndex');
