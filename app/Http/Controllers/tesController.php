...
class tesController extends Controller
{
    public function index()
    {
        ...
        return view('instruktur.tes.index', compact('data', 'mapel', 'periode'));
    }
    ...
    public function show($uuid)
    {
        ...
        return view('instruktur.tes.show', compact('data', 'tes'));
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('instruktur.tes.edit', compact('data', 'periode'));
    }
